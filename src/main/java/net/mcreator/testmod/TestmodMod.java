 ...
 *
 *    Keep the TestmodModElements object in this class and all calls to this object
...
public class TestmodMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("testmod", "testmod"),
			() -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	public TestmodModElements elements;
	public TestmodMod() {
		elements = new TestmodModElements();
